...
var VatCalculator = (function (d) {
    ...
    var rate, vatEvent, raiseVat, calcVat, addVat, getRate;   
	...
	// Add init object with argument
	init = function (newRate) {
		// Store the passed value in the modules rate variable
		if(newRate != null){
			rate = newRate;
		}
